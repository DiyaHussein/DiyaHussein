...
<h3 align="center">Systems Engineer — Low-Latency Infrastructure & Quantitative Systems</h3>

<p align="center">
  <img src="https://img.shields.io/badge/Location-Timi%C8%99oara%2C%20Romania-888" alt="Location">
  <img src="https://img.shields.io/badge/Open_to-Zurich%20%7C%20Zug%20%7C%20Shenzhen-red" alt="Open to">
...
I build infrastructure where latency is measured in microseconds: trading engines, kernel-bypass proxies, and production ML serving at scale.

My work spans **Rust systems programming**, **distributed systems**, and **quantitative infrastructure** — order book simulation, backtesting engines, and real-time data pipelines.

### Projects

| Project | Description | Stack |
|---------|-------------|-------|
| [rust-quant-engine](https://github.com/DiyaHussein/rust-quant-engine) | Tick-level backtesting engine with limit order book simulation and performance metrics | Rust, PyO3 |
| [tcp-proxy-rs](https://github.com/DiyaHussein/tcp-proxy-rs) | Asynchronous L4 proxy leveraging io_uring for kernel-bypass I/O | Rust, tokio, io_uring |
